...
|---|---|---|
| Расчёт маршрутов с минимизацией километража | POST /api/v1/optimize + Greedy fallback | 1-2 |
...
| Выгрузка аналитической информации | Excel 6 листов + обратный импорт | 4 |
...
- Excel экспорт (6 листов: расписание, журнал, статистика, активность ТП, журнал изменений, маршруты навигатор)
...
- Backend: /api/v1/optimize/variants (3 варианта + LLM pros/cons), /api/v1/optimize/confirm
