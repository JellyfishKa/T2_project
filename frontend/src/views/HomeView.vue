<template>
  <div class="space-y-8 py-6 md:py-8">
    <PageHero
      eyebrow="Т2.Логист"
      title="Т2.Логист"
      description="Комплексная платформа для алгоритмической оптимизации маршрутов магазинов и сетевой аналитики."
    >
      <template #meta>
    ...
    <div class="grid gap-4 md:grid-cols-3">
      ...
      <InfoStatCard label="Контроль качества" value="Метрики + сравнение" hint="Система ранжирует варианты, метрики подтверждают результат." tone="green" />
...
const quickActions = [
  {
    ...
    short: '01',
    to: '/dashboard',
    description: 'Быстрый обзор маршрутов, источников расчёта и текущего состояния сервиса.',
  ...
  },
  {
    ...
    short: '02',
    to: '/optimize',
    description: 'Сравните альтернативы и выберите лучший порядок точек.',
...
const workflowSteps = [
  ...
  },
  {
    ...
    description: 'Проверьте варианты алгоритма, вручную перестройте и примените лучший порядок.',
  },
  {
    index: 'Шаг 3',
