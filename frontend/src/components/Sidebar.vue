  ...
  <div class="flex h-full flex-col bg-white border-r border-gray-200">
    ...
    <nav class="flex-1 space-y-1 px-4 py-6">
      ...
      >
        ...
        <div class="mr-3 h-5 w-5 flex-shrink-0" :class="isActive(item.to) ? 'text-blue-500' : 'text-gray-400 group-hover:text-blue-500'">
          <svg v-if="item.name === 'Home'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
          </svg>
          <svg v-else-if="item.name === 'Dashboard'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
          <svg v-else-if="item.name === 'Optimize'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
