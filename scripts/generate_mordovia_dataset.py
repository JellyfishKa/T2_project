...
DISTRICT_CITIES = {
    "г.о. Саранск": "Саранск",
    "Ардатовский район": "Ардатов",
    "Атяшевский район": "Атяшево",
    "Атюрьевский район": "Атюрьево",
    "Большеберезниковский район": "Большие Березники",
    "Большеигнатовский район": "Большое Игнатово",
    "Дубёнский район": "Дубёнки",
    "Ельниковский район": "Ельники",
    "Зубово-Полянский район": "Зубова Поляна",
    "Инсарский район": "Инсар",
    "Ичалковский район": "Кемля",
    "Кадошкинский район": "Кадошкино",
    "Ковылкинский район": "Ковылкино",
    "Кочкуровский район": "Кочкурово",
    "Краснослободский район": "Краснослободск",
    "Лямбирский район": "Лямбирь",
    "Ромодановский район": "Ромоданово",
    "Рузаевский район": "Рузаевка",
    "Старошайговский район": "Старое Шайгово",
    "Темниковский район": "Темников",
    "Теньгушевский район": "Теньгушево",
    "Торбеевский район": "Торбеево",
    "Чамзинский район": "Чамзинка",
}
...
DISTRICT_STREETS = {
    "Рузаевский район": ["ул. Ленина", "ул. Краснозаводская", "ул. Маяковского", "ул. Титова"],
    "Ковылкинский район": ["ул. Свердлова", "ул. Советская", "ул. Большевистская", "ул. Пролетарская"],
    "Краснослободский район": ["ул. Интернациональная", "ул. Кирова", "ул. Коммунистическая", "ул. Советская"],
    "Темниковский район": ["ул. Советская", "ул. Бараева", "ул. Лесная", "ул. Октябрьская"],
    "Чамзинский район": ["ул. Республиканская", "ул. Советская", "ул. Молодёжная", "ул. Заводская"],
}
...
def _address_for_location(district: str, city: str, idx: int) -> str:
    """Формирует детерминированный тестовый адрес с улицей и домом."""
    if district == "г.о. Саранск":
        street = random.choice(SARANSK_STREETS)
    else:
        street_pool = DISTRICT_STREETS.get(district, COMMON_STREETS)
        street = random.choice(street_pool)

    house = (idx * 7) % 120 + 1
    building = f"{house}"

    # Иногда добавляем корпус/строение, чтобы данные выглядели живее.
    if idx % 9 == 0:
        building = f"{house} к{idx % 3 + 1}"
    elif idx % 13 == 0:
        building = f"{house} стр. {idx % 2 + 1}"
    ...
    for district, info in DISTRICTS.items():
        ...
        for i, category in enumerate(categories):
            ...
            locations.append({
                ...
                "city": city,
                "district": district,
                "address": _address_for_location(district, city, idx),
            })
            idx += 1
