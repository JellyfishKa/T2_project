...
## Конкурсные требования — статус

| Требование | Реализация |
|-----------|-----------|
| Расчёт маршрутов с минимизацией километража | ✅ `/optimize` + `/optimize/variants` |
| Учёт рабочего времени (9–18) | ✅ SchedulePlanner |
| Сегментация ТТ A/B/C/D | ✅ Категории с частотой визитов |
| 100% охват базы ТТ | ✅ `insights.coverage_percent` |
| Форс-мажоры + перераспределение | ✅ `force_majeure_service.py` |
| Отчёт о времени нахождения на каждой ТТ | ✅ `time_in`/`time_out` + Excel «Журнал» |
| Детализация по времени и дате посещения | ✅ VisitLog + Excel лист 2 |
| Количество выходов ТП на маршрут | ✅ Excel «Активность ТП» + insights |
| Выгрузка аналитической информации | ✅ Excel 4 листа + импорт |
