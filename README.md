...
**Длительность разработки**: 5 недель
**Размер команды**: 3 разработчика + 1 TL/PM
**Методология**: Agile Lite (Kanban)
**Статус**: ✅ Production-Ready (v1.2.0 — 10 марта 2026)
...
- [x] State machine визитов — валидация переходов статусов (422 на invalid transition)
- [x] Защита от дублирования генерации расписания (409 + `?force=true`)
- [x] AuditLog — журнал изменений (миграция 003) + 5-й лист в Excel
- [x] Расширенный health check: `disk_free_mb`, `visits_today`, `version`
- [x] Warning при переводе сотрудника на sick/vacation
